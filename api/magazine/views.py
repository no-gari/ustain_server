from api.magazine.serializers import MagazinesListSerializer, MagazineReviewsListSerializer, \
    MagazineRetrieveSerializer, MagazineLikeSerializer, MagazineScrapUpdateSerializer, \
